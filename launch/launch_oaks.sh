...
echo Visualise images? (Y/n)
read visualise

if [ "$visualise" = "Y" ]
then
python3 src/development/scripts/publish_yolo_detections_single_camera.py --oak_camera_num $oak_id --ros_tf_frame oak_${oak_id}_frame --ros_output_topic /spencer/perception_internal/detected_persons/oak_$oak_id --visualise True
else
